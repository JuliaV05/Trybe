...
// const numbers = [1, 32, 44, 2, 3];
// const totalSum = numbers.reduce((acc, curr) => { acc + curr;}, 30); // O `valorInicial` é 30, ou seja, `acc` antes de executar a primeira iteração já está armazenando esse valor.
